...
$stock=$_POST['stock'];
$sql="INSERT INTO products (name, category_id, supplier_id, purchase_price, sale_price, stock)VALUES('$name', '$category', '$supplier', '$purchase', '$sale', '$stock')";
    ...
    <div class="sidebar">
        <div class="sidebar-top">
            ...
            <ul class="nav-links">
                ...
                <li class="active"><a href="product.php"><i class="fa-solid fa-box"></i> Products</a></li>
